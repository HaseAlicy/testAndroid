...
public class QRReader extends AppCompatActivity implements SurfaceHolder.Callback,View.OnClickListener {
    ...
    private class BarcodeTracker extends Tracker<Barcode> {
        ...
        public void onNewItem(final int id, final Barcode item) {
            QRReader.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(QRReader.this, "" + id + " : " + item.rawValue,
